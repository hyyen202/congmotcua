...
<!-- Menu -->
    <nav id="menu">
        ...
        <ul>
            <li class="funtion"><a href="/authenticate">
            ...
            <li class="funtion"><a href="/register">
                <i class="fa-solid fa-table"></i> Quản lý đăng ký
            </a></li>
            <li class="funtion">
                <span class="opener">
                    <i class="fa-solid fa-table"></i> Đăng ký các loại giấy tờ
                </span>
                <ul>
                    <li><a href="/register/nvqs">Nghĩa vụ quân sự</a></li>
                    <li><a href="/register/result">Bảng điểm tạm thời</a></li>
                    <li><a href="/register/loan">Giấy vay vốn</a></li>
                    <li><a href="/register/certificate">Bản sao bằng tốt nghiệp </a></li>
                </ul></li>
            ...
            <li class="funtion"><a href="/return">
            ...
            <li class="funtion"><a href="/accept">
