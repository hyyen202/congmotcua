        ...
        <section class="vh-100">
            <div class="container-fluid h-custom">
              <div class="row d-flex justify-content-center align-items-center h-100">
                <div class="col-md-9 col-lg-6 col-xl-5 d-flex align-items-center justify-content-center">        
                    <div class="text-center">
                        <img src="https://upload.wikimedia.org/wikipedia/commons/b/ba/Logo_ctuet.png" class="img-fluid"> 
                        <div class="text-logo big-logo">
                            <span class="">Cổng thông tin sinh viên</span> <br>
                            <span class="ctuet">TRƯỜNG ĐẠI HỌC KỸ THUẬT - CÔNG NGHỆ CẦN THƠ</span>
                        </div>
                    </div>
                </div>
                  ...
                  <form>
                    ...
                    <div class="text-center text-lg-start mt-4 pt-2">
                      <button type="button" class="btn btn-primary btn-lg"
                        style="padding-left: 2.5rem; padding-right: 2.5rem;" onclick="login()">Sign in</button>
                      <p class="small fw-bold mt-2 pt-1 mb-0">Sign in with
                        <a class="px-2 py-2 mr-md-1 rounded " onclick="window.location='{{ route('loginbygoogle') }}'" 
